...
def battle(rarity_life, discord_life, choice):
    ...
    #Rarity punches Discord
    if choice == 'e':
        discord_life = discord_life - 2
...
while rarity_life > 0 and discord_life > 0:
    ...
    print("a=Rarity hits Discord   b=Discord hits Rarity  c=Discord takes her horn   d=nothing  e=Rarity punches Discord")
